...
function AdminLogin() {
    ...
    const formik = useFormik({
        ...
        onSubmit: () => {
            axios
                .post(`${apiConfig.baseURL}/admin-login`, {
                ...
                .then((response) => {
                    if (response.status === 200) {
                        ...
                        Cookies.set("admin-token", token, { expires: 60 * 60 })
                        setTimeout(() => {
        ...
        <div>
            <div className="bg-yellow-400 dark:bg-gray-800 h-screen overflow-hidden flex items-center justify-center">
                <div className="bg-white lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl">
                    ...
                    <form className="p-12 md:p-24" onSubmit={formik.handleSubmit}>
                        <p className="flex justify-center mb-4 text-2xl font-bold">ADMIN</p>
